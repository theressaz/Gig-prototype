...
?>
    ...
    <div class="page-toolbar">
      <div>
        ...
        <p style="font-size:0.86rem;color:var(--text-muted);margin-top:4px;">Kandidat mencakup Gig Worker yang melamar maupun yang mendapat penawaran langsung dari perusahaan. Kontak tidak ditampilkan sampai kerja sama disetujui.</p>
      </div>
    ...
    <div class="privacy-lock-note">
      ...
      Klik nama atau <strong>Lihat Profil</strong> untuk keterampilan, pengalaman, portofolio, dan ulasan. Gunakan <strong>Tawarkan Proyek</strong> di halaman <a href="employer-cari-mitra.php" style="color:var(--primary-blue);">Cari Mitra</a> untuk mengundang Gig Worker secara langsung.
    </div>
      ...
      <article class="applicant-card" data-category="<?php echo htmlspecialchars($applicant['category'], ENT_QUOTES, 'UTF-8'); ?>">
        <div class="applicant-left-info">
          ...
          <div class="applicant-details">
            ...
            <div class="applicant-lock-hint">Kontak dikunci hingga kerja sama disetujui</div>
          </div>
        </div>

...
$navItems = [
    ...
    'bursa' => ['href' => 'worker-bursa.php', 'title' => 'Lowongan Proyek', 'icon' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>'],
    ...
    <header class="app-navbar">
      ...
      <div class="navbar-center">
        <form class="search-bar" action="worker-bursa.php" method="get">
          ...
          <input type="text" name="q" placeholder="Cari tugas atau lowongan proyek..." value="<?php echo htmlspecialchars((string)($_GET['q'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" />
        </form>
      </div>

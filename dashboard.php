...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* RECENT ACTIVITIES TABLE (Matching the bottom card in screenshot) */
    .activity-list {
      display: flex;
      flex-direction: column;
      gap: 10px;
...
<body>
  ...
  <header class="kemnaker-header">
    <div class="header-inner">
      ...
      <nav class="header-tabs">
        <a href="#" class="header-tab active">Daftar Pekerjaan</a>
        <a href="#" class="header-tab">Profil ▾</a>
        <a href="#" class="header-tab">Ulasan Perusahaan</a>
  ...
  <main class="page-main">
      ...
      <div class="hero-header">
        <div>
          <div class="hero-badge">
            ...
            WAJIB LAPOR KETENAGAKERJAAN &bull; GIG SECTOR
          </div>
          <h1 class="hero-title">Ringkasan Gig Worker &amp; WLLP</h1>
          <p class="hero-desc">
            Pantau pelaporan, status kepesertaan jaminan sosial, dan bukti lapor ketenagakerjaan mitra gig dalam satu dashboard terpadu.
          </p>
        </div>

        <div class="hero-actions">
          <span class="btn-hero-glass">Dashboard Pengembangan</span>
          <span class="btn-hero-solid">+ Buat Laporan Gig</span>
        </div>
      </div>
    </section>
    ...
    <!-- 4 STATS CARDS (EXACT MATCH TO SCREENSHOT) -->
    <section class="stats-grid">
      ...
      <article class="stat-card">
        ...
        <div class="stat-caption">Masih dalam masa berlaku</div>
      </article>
      ...
      <article class="stat-card">
        ...
        <div class="stat-caption">Kebutuhan telah terpenuhi</div>
      </article>

      <article class="stat-card">
        <div class="stat-card-header">
          <span class="stat-label">BELUM TERISI</span>
          <div class="stat-icon-wrapper amber">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
          </div>
        </div>
        <div class="stat-number">0</div>
        <div class="stat-caption">Perlu pemantauan lanjutan</div>
      </article>
    </section>
    ...
    <div class="middle-grid">
      ...
      <section class="white-card">
        <h2 class="card-title">
          <span>Distribusi Status Lowongan</span>
      ...
      <section class="white-card">
        ...
        <div class="quick-access-grid">
          <a href="#" class="quick-access-tile">
            ...
            <div>
              <div style="font-size: 0.85rem; font-weight: 700;">Pelaporan Lowongan</div>
          ...
          <a href="#" class="quick-access-tile">
            ...
            <div>
              ...
              <div style="font-size: 0.72rem; color: var(--text-muted);">Kelola lowongan terpasang</div>
            </div>
          </a>
        </div>
      </section>
    ...
    <!-- RECENT ACTIVITY CARD (Matching the bottom card in screenshot) -->
    <section class="white-card">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div>
          <h2 style="font-size: 1.05rem; font-weight: 700; color: var(--text-main);">Aktivitas Terbaru WLLP</h2>
          <p style="font-size: 0.78rem; color: var(--text-muted);">Riwayat pelaporan lowongan kerja Anda</p>
        </div>
